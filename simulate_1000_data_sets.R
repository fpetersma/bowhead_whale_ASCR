## ========================================================================== ##
## Simulate the data for simulation studies                                   ##
## ========================================================================== ##
...
simulated_data <- lapply(1:1000, function(sim_i) {
  ...
  par_dens <- c("(Intercept)" = -12,
                "distance_to_coast" = 45,
                "distance_to_coast2" = -53)
  ## =============================================================================
  ...
  rm(list = setdiff(ls(), c("sim_data", "output", "sim_i")))
