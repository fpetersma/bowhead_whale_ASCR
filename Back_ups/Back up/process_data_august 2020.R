...
df_full <- df %>% 
  ...
  filter(n_sensors > 1)# remove single detection calls
...
ranges <- select(df_full_31082010, paste0("range_", 1:6))
...
write.csv(ranges, "../JABES paper/Data/range_31-08-2020_all.csv", row.names = F)
