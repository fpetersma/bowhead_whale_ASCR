...
density_grid <- read.csv("Data/Masks/[PT] mask_buffer=75km_deltaX=5158_deltaY=5208_grid=406_with_area_longlat.csv")
density_grid$dist_to_coast <- density_grid$distance_to_coast
...
detectors <- detectors[, c("long", "lat")]
