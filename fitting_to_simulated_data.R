...
## =============================================================================
## 1. LOAD THE SIMULATED DATA FILE
## -----------------------------------------------------------------------------
...
results <- lapply(simulated_data[1:n], function(dat) {
  ...
  A_s <- 3
  FIXED_SL <- TRUE
  USE_BEARINGS <- 2   # use mixture distribution on bearings
  
  ## ===========================================================================
  ## 2.1 SET UP DENSITY MODEL
  ## ---------------------------------------------------------------------------
  ## Fit using the correct density model
  # f_density <- D ~ distance_to_coast + distance_to_coast2   # for variable D
  f_density <- D ~ 1                                        # for constant D
